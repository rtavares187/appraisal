...
--
-- Host: 127.0.0.1    Database: jb_appraisal
-- ------------------------------------------------------
...
DROP DATABASE IF EXISTS `jb_appraisal`;

CREATE DATABASE `jb_appraisal`;
...
-- Dump completed on 2017-04-10 22:07:03
